...
public class FuelListTest extends ActivityInstrumentationTestCase2{
    ...
    public void testGetFill(){
        ...
        assertEquals(returnedTweet.getGrade(), fill.getGrade());
        assertEquals(returnedTweet.getOdometer(), fill.getOdometer());
        assertEquals(returnedTweet.getCost(), fill.getCost());
        assertEquals(returnedTweet.getAmount(), fill.getAmount());
        assertEquals(returnedTweet.getUnit(), fill.getUnit());
    }
